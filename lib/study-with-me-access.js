...
export function getStudyWithMeLockMessage(access) {
  switch (access?.reason) {
    case "allowed":
      return "";
    case "not-premium":
      return "Disponible solo para alumnos Premium.";
    case "no-commission":
    case "inactive-commission":
      return "Disponible para alumnos Premium con curso activo.";
    case "non-student":
      return "Completa tu matricula para habilitar Study With Me.";
    default:
      return "No pudimos validar tu acceso a Study With Me.";
  }
}
