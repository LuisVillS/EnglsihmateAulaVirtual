...
export const SKILL_TAG_VALUES = ["speaking", "reading", "grammar", "listening"];
...
function buildStudentSkillsBundle({
  ...
  const currentListening = clampScore(listeningOverride?.listening_value_0_100) ?? clampScore(current.listening);
