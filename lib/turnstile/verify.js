...
export function isLocalTurnstileHost(host) {
...
export function shouldSkipTurnstileValidationForHost(host) {
  return process.env.NODE_ENV !== "production" && isLocalTurnstileHost(host);
}
