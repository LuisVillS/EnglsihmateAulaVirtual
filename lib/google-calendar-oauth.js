...
import { requirePrivateServerEnv, resolveCanonicalAppUrl } from "./security/env.js";
...
function getStateSecret() {
  return requirePrivateServerEnv("CALENDAR_OAUTH_STATE_SECRET", {
    label: "CALENDAR_OAUTH_STATE_SECRET",
  });
}
...
export function resolveGoogleRedirectUri(origin = resolveCanonicalAppOrigin()) {
